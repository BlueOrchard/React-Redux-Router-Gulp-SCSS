...
gulp.task('default', ['cssPack', 'packReact'], function() {
    ...
    gulp.watch(devJS + 'layout/*.js', ['packReact']);
    gulp.watch(devJS + 'reducers/*.js', ['packReact']);
    gulp.watch(devJS + 'actions/*.js', ['packReact']);
    gulp.watch(devJS + 'components/*.js', ['packReact']);
    gulp.watch(devJS + 'containers/*.js', ['packReact']);
})